    ...
    <div className={`customize ${isOpen ? "right-0" : ""}`}>
      ...
      <div className="customize__palets">
        ...
        <ColorPalet
          ...
          secondary="rgb(0,172,151)"
          name="green"
        />
        <ColorPalet
          primary="rgb(47,193,255)"
          secondary="rgb(8,172,242)"
          name="turquoise"
        />
        <ColorPalet
          primary="rgb(65,117,252)"
          secondary="rgb(8,74,243)"
          name="blue"
        />
        <ColorPalet
          primary="rgb(27,174,112)"
          secondary="rgb(6,117,46)"
          name="darkgreen"
        />
        <ColorPalet
          primary="rgb(249,195,73)"
          secondary="rgb(255,177,0)"
          name="yellow"
        />
        <ColorPalet
          primary="rgb(255,106,151)"
          secondary="rgb(250,3,107)"
          name="red"
        />
        <ColorPalet
          primary="rgb(239,77,72)"
          secondary="rgb(217,7,0)"
          name="darkred"
        />
      </div>
      {/*  */}
